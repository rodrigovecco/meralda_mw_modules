<?php
/**
 * Core migration 000001: users table (Meralda original base table).
 */
class mwmod_mw_dbcore_m000001users extends mwmod_mw_db_migrations_itemabs {
	...
	function check() {
		return !$this->table_exists("users");
	}
